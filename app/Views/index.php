...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand fw-bold" href="/">Sandeep Hospital</a>
...
<section class="hero">
    <div class="container">
        <h1 class="display-4 fw-bold">Welcome to Sandeep Hospital</h1>
...
<section class="about" id="about">
    <div class="container">
        ...
        <p class="lead text-center">
            Sandeep Hospital was founded in 2025 by <strong>Dr. Sandeep Shetty</strong> with a vision to provide affordable and 
