        ...
        <div class="col-md-8">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <!-- Doctor Form -->
                    <form method="post" action="<?= base_url('users/add_from_user/'.$user['id']) ?>">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="consultation_fee" class="form-control" placeholder="e.g., 500" min="0" required>
                        </div>

                        <button type="submit" class="btn btn-primary w-100">Add Doctor Info</button>
                    </form>

                    <div class="mt-3">
                        <a href="<?= base_url('users/') ?>" class="btn btn-secondary w-100">Back to User List</a>
                    </div>
